...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center pt-20 pb-16 px-4 relative">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              {/* Typing Animation */}
              <div className="h-10 text-2xl md:text-3xl font-medium text-gray-300">
            ...
            >
              {stats.map((stat, index) => (
                ...
                >
                  <stat.icon className="w-6 h-6 mx-auto mb-2 text-primary-light" />
          ...
          >
            <div className="relative">
              ...
              <div className="relative">
                <motion.div
                  className="w-72 h-72 md:w-96 md:h-96 rounded-full overflow-hidden glow-border glass"
                  animate={{ y: [0, -10, 0] }}
                  transition={{
                    duration: 6,
                    repeat: Infinity,
                ...
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 1 }}
                  className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 glass px-6 py-3 rounded-full flex items-center gap-3 shadow-xl"
                >
                  <motion.div
                    className="w-3 h-3 bg-green-500 rounded-full shadow-[0_0_10px_rgba(34,197,94,0.6)]"
